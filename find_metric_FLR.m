...
%W pos def
p_low = (delta_4'*W*delta_4 - w_lower*(delta_4'*delta_4)) - Ll*box_lim(1:4);
p_high = (w_upper*(delta_4'*delta_4) - delta_4'*W*delta_4) - Lu*box_lim(1:4);
    ...
    if (solved==0)
        ...
        for i = 1:4
            for j = 1:4
                ...
                dW_x1_ij = strcat('@(x1,x2)',dW_x1_ij{1});
        ...
        W_mat = @(x)     [W_cell{1,1}(x(1),x(2)), W_cell{1,2}(x(1),x(2)), W_cell{1,3}(x(1),x(2)), W_cell{1,4}(x(1),x(2));
            W_cell{2,1}(x(1),x(2)), W_cell{2,2}(x(1),x(2)), W_cell{2,3}(x(1),x(2)), W_cell{2,4}(x(1),x(2));
            W_cell{3,1}(x(1),x(2)), W_cell{3,2}(x(1),x(2)), W_cell{3,3}(x(1),x(2)), W_cell{3,4}(x(1),x(2));
            W_cell{4,1}(x(1),x(2)), W_cell{4,2}(x(1),x(2)), W_cell{4,3}(x(1),x(2)), W_cell{4,4}(x(1),x(2))];
        
        dW_x1_mat = @(x) [dW_x1_cell{1,1}(x(1),x(2)), dW_x1_cell{1,2}(x(1),x(2)), dW_x1_cell{1,3}(x(1),x(2)), dW_x1_cell{1,4}(x(1),x(2));
            dW_x1_cell{2,1}(x(1),x(2)), dW_x1_cell{2,2}(x(1),x(2)), dW_x1_cell{2,3}(x(1),x(2)), dW_x1_cell{2,4}(x(1),x(2));
            dW_x1_cell{3,1}(x(1),x(2)), dW_x1_cell{3,2}(x(1),x(2)), dW_x1_cell{3,3}(x(1),x(2)), dW_x1_cell{3,4}(x(1),x(2));
            dW_x1_cell{4,1}(x(1),x(2)), dW_x1_cell{4,2}(x(1),x(2)), dW_x1_cell{4,3}(x(1),x(2)), dW_x1_cell{4,4}(x(1),x(2))];
        
        dW_x2_mat = @(x) [dW_x2_cell{1,1}(x(1),x(2)), dW_x2_cell{1,2}(x(1),x(2)), dW_x2_cell{1,3}(x(1),x(2)), dW_x2_cell{1,4}(x(1),x(2));
            dW_x2_cell{2,1}(x(1),x(2)), dW_x2_cell{2,2}(x(1),x(2)), dW_x2_cell{2,3}(x(1),x(2)), dW_x2_cell{2,4}(x(1),x(2));
            dW_x2_cell{3,1}(x(1),x(2)), dW_x2_cell{3,2}(x(1),x(2)), dW_x2_cell{3,3}(x(1),x(2)), dW_x2_cell{3,4}(x(1),x(2));
            dW_x2_cell{4,1}(x(1),x(2)), dW_x2_cell{4,2}(x(1),x(2)), dW_x2_cell{4,3}(x(1),x(2)), dW_x2_cell{4,4}(x(1),x(2))];
